...
export default function LaptopModel(props: GroupProps) {
  const group = useRef<THREE.Group | null>(null); // Use null instead of undefined
  const { nodes, materials } = useGLTF('/laptoptest.gltf') as unknown as GLTFResult;
...
useGLTF.preload('/laptoptest.gltf');
